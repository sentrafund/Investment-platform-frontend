      ...
      <main className=" h-96 text-white bg-blue-950">
        <section className="flex items-start justify-around mb-13 align-text-top ">
          ...
          <div className="mt-10">
            ...
            <div className="w-[371px] h-[96px]">
              ...
              forex and more with more confidence and security
            </div>
          </div>
          {/* Services */}
          <div className="mt-10">
            <div className="mb-5 font-bold "> Services</div>
            <div className="mb-3 hover:text-yellow-500 cursor-pointer transition duration-300 ease-in">
              {" "}
              Stock Trading
            </div>
            <div className="mb-3  hover:text-yellow-500 cursor-pointer transition duration-300 ease-in">
          ...
          <div className="mt-10">
            ...
            <div className="mb-5 flex gap-2 hover:text-yellow-500 cursor-pointer transition duration-300 ease-in">
              <div>
                {" "}
                <img src="/material-symbols_mail-outline-rounded.svg" alt="" />
              </div>
            ...
            <div className="flex gap-2 hover:text-yellow-500 cursor-pointer transition duration-300 ease-in">
              <div>
                {" "}
                <img src="ri_whatsapp-line.svg" alt="" />
              </div>
              <div> +234---------- </div>
            </div>
          </div>
        ...
        <section className="flex justify-between mx-14 items-center mt-5 mb-0">
          <div className="flex gap-2 items-center">
            <div>
              {" "}
              <img src="ic_baseline-copyright.svg" alt="copyright icon" />
            </div>
            <div> 2025 Sentrafunds. All rights reserved</div>
          </div>
          <div className="flex space-x-6">
            <div className=" hover:text-yellow-500 cursor-pointer transition duration-300 ease-in">
              {" "}
              Privacy Policy
            </div>
            <div className=" hover:text-yellow-500 cursor-pointer transition duration-300 ease-in">
