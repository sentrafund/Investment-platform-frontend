...
export default function InvestmentForm() {
  ...
  const investmentPlans = ["ProStartup", "Premium Plan"];
  ...
  return (
    <div className="w-full max-w-[90%] sm:max-w-lg mx-auto bg-white rounded-2xl shadow-xl p-6 sm:p-8 space-y-6 transform hover:scale-[1.02] transition-all duration-300">
      {/* Name Field */}
